odoo.define('car_repair_dashboard.Dashboard', function (require) {
"use strict";
...
var CarRepairDashboard = AbstractAction.extend({
    template: 'CarRepairDashboardMain',
    cssLibs: [
        '/car_repair_dashboard/static/src/css/lib/nv.d3.css'
    ],
    jsLibs: [
...
core.action_registry.add('car_repair_dashboard', CarRepairDashboard);

return CarRepairDashboard;
